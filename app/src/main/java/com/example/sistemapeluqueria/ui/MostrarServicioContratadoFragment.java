            ...
            @Override public void onResponse(String response)
            {
                try
                {
                    ...
                    for (int i = 0; i<jsonArray.length(); i++)
                    {
                        ...
                        ContractedServiceModel servicioContratado =  new ContractedServiceModel(object.getInt("pk_ContratarServicio"), object.getString("nombrePersonal"), object.getString("nombreServicio"), object.getInt("total"), object.getString("direccion"), object.getString("fecha"),object.getString("hora"), object.getString("estado"), object.getInt("precio"), object.getInt("cantidad"),object.getInt("calificacion") );
